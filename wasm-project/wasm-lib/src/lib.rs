...
pub fn get_attraction_force_vector2(m1: f64, m2: f64, r: na::Vector2<f64>) -> na::Vector2<f64> {
    let g = 6.67408 * 10.0_f64.powi(-11); 
...
mod tests {
    ...
    fn test_get_attraction_force_vector() {
        let result = get_attraction_force_vector2(1.0, 1.0, na::Vector2::new(1.0, 1.0));
